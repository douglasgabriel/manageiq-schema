  ...
  context "resources with asset detail" do
    ...
    migration_context :down do
      ...
      it "should migrate the data back from asset_details to physical_chassis and physical_servers tables" do
        asset_detail_chassis = asset_detail_stub.create!(:location_led_state => 'Blinking', :resource_type => "PhysicalChassis", :resource_id => physical_chassis.id)
        asset_detail_server  = asset_detail_stub.create!(:location_led_state => 'Off', :resource_type => "PhysicalServer", :resource_id => physical_server.id)
